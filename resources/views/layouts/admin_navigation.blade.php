...
<nav x-data="{ open: false }" class="bg-green-600 border-b">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <div class="flex justify-between h-16 ">
            ...
            <div class="flex ">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('solicitud_negocio')" :active="request()->routeIs('solicitud_negocio')">
                        {{ __('Negocios') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('nueva_etiqueta')" :active="request()->routeIs('nueva_etiqueta')">
                        {{ __('Etiquetas') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('soporte_respuesta')" :active="request()->routeIs('soporte_respuesta')">
                        {{ __('Soporte') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('solicitud_negocio')" :active="request()->routeIs('solicitud_negocio')">
                {{ __('Negocios') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('producto')" :active="request()->routeIs('producto')">
                {{ __('Productos') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('nueva_etiqueta')" :active="request()->routeIs('nueva_etiqueta')">
                {{ __('Etiquetas') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('soporte_respuesta')" :active="request()->routeIs('soporte_respuesta')">
                {{ __('Soporte') }}
            </x-responsive-nav-link>
        </div>
